...
export function Wellness({ searchValue }: WellnessProps) {
  ...
  const { data: places, isLoading } = useApprovedThirdPartyPlaces("wellness");

  // Fetch hotel's relationship with places
  const { data: hotelPlaces } = useHotelPlaces(hotelId, "wellness");
      ...
      <div className="mb-6 flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Wellness centers, spas, and health service providers from Google
            Places
          </p>
        </div>
      ...
      <Table
        ...
        emptyMessage={
          searchValue
            ...
            : "No wellness places available yet."
        }
        pagination={{
          pageSize: 10,
          showPageSize: true,
